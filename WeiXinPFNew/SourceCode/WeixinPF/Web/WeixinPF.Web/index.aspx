<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="WeixinPF.Web.index" %>
...
<head>
    ...
    <script type="text/javascript" src="Common/jquery/jquery.nicescroll.js"></script>
    ...
    <script type="text/javascript">
        ...
        function loadMenuTree(_islink) {
            ...
            $.ajax({
                type: "post",
                url: "Functoin/BackPage/Admin/tools/admin_ajax.ashx?action=get_navigation_list&time=" + Math.random(),
                dataType: "html",
...
<%--                                </li>--%>
                        ...
                        <li class="dropdown dropdown-nochild user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li id="mygzh" runat="server">
                                    <a navid="list_weixin" href="Functoin/BackPage/Admin/weixin/myweixinlist.aspx" target="mainframe" class="item selected">我的公众帐号
                                    </a>
                                </li>
    ...
    <script src="Common/knockout/knockout-3.3.0.js" type="text/javascript"></script>
