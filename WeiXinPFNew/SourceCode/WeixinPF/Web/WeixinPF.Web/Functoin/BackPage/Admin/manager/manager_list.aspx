<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager_list.aspx.cs" Inherits="WeixinPF.Web.Functoin.BackPage.Admin.manager.manager_list" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <a href="javascript:;" class="home"><i></i><span>微用户列表</span></a>
        </div>
        <!--/导航栏-->
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="add" href="manager_edit.aspx?action=<%=MXEnums.ActionEnum.Add %>"><i></i><span>新增微用户</span></a></li>
        ...
        <asp:Repeater ID="rptList" runat="server">
            <HeaderTemplate>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                    <tr>
                        ...
                        <th align="left" width="11%">已建微帐号数量</th>
                        <th align="left" width="11%">最大数量</th>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center">
                        <a href="manager_edit.aspx?action=<%#MXEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
                        <a href="weixin_list.aspx?action=<%#MXEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">管理微账号</a>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
