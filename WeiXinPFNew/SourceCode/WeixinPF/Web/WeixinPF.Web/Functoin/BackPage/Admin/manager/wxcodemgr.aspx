<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wxcodemgr.aspx.cs" Inherits="WeixinPF.Web.Functoin.BackPage.Admin.manager.wxcodemgr" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="javascript:;" class="home"><i></i><span>微帐号管理</span></a>
        </div>
        <!--/导航栏-->
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center">
                        <a href="wxcode_edit.aspx?action=<%#MXEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">管理</a>
