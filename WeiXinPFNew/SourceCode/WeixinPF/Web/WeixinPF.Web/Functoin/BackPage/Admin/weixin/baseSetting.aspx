<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="baseSetting.aspx.cs" Inherits="WeixinPF.Web.Functoin.BackPage.Admin.weixin.baseSetting" %>
...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            //初始化表单验证
            $("#form1").initValidform();
            $(".upload-attach").InitSWFUpload({ filesize: "51200", sendurl: "../tools/upload_ajax.ashx", flashurl: "../../../../Common/swfupload/swfupload.swf", filetypes: "*.gif;*.jpg;*.png;*.bmp;*.rar;*.zip;*.doc;*.xls;*.txt;*.p12" });
