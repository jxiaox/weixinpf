<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="center.aspx.cs" Inherits="WeixinPF.Web.center" %>
        ...
        <ol class="ol-decimal text-indet">
                ...
                <div class="in" id="collapseLi1" aria-expanded="true">
                    <div class="well metro-height">
                        ...
                        <div class="tile btn btn-primary" data-role="tile"
                            ...
                            <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/酒店管理员/商户或门店设置.htm');">
                        ...
                        <div class="tile btn btn-primary" data-role="tile"
                            ...
                            <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/酒店管理员/商品管理.htm');">
                                <i class="fa fa-question fa-lg"></i>
                            </a>
                ...
                <div class="in" id="collapseLi2" aria-expanded="true">
                    <div class="well metro-height">
                        <div class="tile btn btn-primary" data-role="tile"
                            ...
                            <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/酒店管理员/订单管理.htm');">
                                <i class="fa fa-question fa-lg"></i>
                            </a>
                ...
                <div class="in" id="collapseLi4" aria-expanded="true">
                    <div class="well metro-height">
                        ...
                        <div class="tile btn btn-primary" data-role="tile"
                            ...
                            <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/酒店管理员/服务凭据查询.htm');">
                                <i class="fa fa-question fa-lg"></i>
                            </a>
                ...
                <div class="in" id="collapseLi5" aria-expanded="true">
                    <div class="well metro-height">
                        <div class="tile btn btn-primary" data-role="tile"
                            ...
                            <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/酒店管理员/管理员设置.htm');">
                                <i class="fa fa-question fa-lg"></i>
                            </a>
            ...
            <li>
                ...
                <div class="in" id="collapseLi6" aria-expanded="true">
                    <div class="well metro-height">
                        <div class="tile btn btn-primary" data-role="tile"
                            onclick="javascript:jumpdirect('Functoin/BackPage/Admin/Manager/manager_pwd.aspx');"
                            style="opacity: 1; transform: scale(1); transition: 0.3s;">
                            ...
                            <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/酒店管理员/密码修改.htm');">
                                <i class="fa fa-question fa-lg"></i>
                            </a>
                ...
                <div class="in" id="collapseLi1" aria-expanded="true">
                    <div class="well metro-height">
                        <div class="tile btn btn-primary" data-role="tile"
                            ...
                            <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/餐饮管理员/商户或门店设置.htm');">
                                <i class="fa fa-question fa-lg"></i>
                            </a>
                        ...
                        <div class="tile btn btn-primary" data-role="tile"
                            ...
                            <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/餐饮管理员/商品分类管理.htm');">
                                <i class="fa fa-question fa-lg"></i>
                            </a>
                        ...
                        <div class="tile btn btn-primary" data-role="tile"
                            ...
                            <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/餐饮管理员/商品管理.htm');">
                                <i class="fa fa-question fa-lg"></i>
                            </a>
                ...
                <div class="in" id="collapseLi2" aria-expanded="true">
                    <div class="well metro-height">
                        <div class="tile btn btn-primary" data-role="tile"
                            ...
                            <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/餐饮管理员/订单管理.htm');">
                                <i class="fa fa-question fa-lg"></i>
                            </a>
                ...
                <div class="in" id="collapseLi8" aria-expanded="true">
                    <div class="well metro-height">
                        <div class="tile btn btn-primary" data-role="tile"
                            ...
                            <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/餐饮管理员/退单管理.htm');">
                                <i class="fa fa-question fa-lg"></i>
                            </a>
                    ...
                    <div class="in" id="collapseLi3" aria-expanded="true">
                        <div class="well metro-height">
                            <div class="tile btn btn-primary" data-role="tile"
                                ...
                                <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/餐饮管理员/服务码验证.htm');">
                                    <i class="fa fa-question fa-lg"></i>
                                </a>
                    ...
                    <div class="in" id="collapseLi4" aria-expanded="true">
                        <div class="well metro-height">
                            ...
                            <div class="tile btn btn-primary" data-role="tile"
                                ...
                                <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/餐饮管理员/服务凭据查询.htm');">
                                    <i class="fa fa-question fa-lg"></i>
                                </a>
                    ...
                    <div class="in" id="collapseLi5" aria-expanded="true">
                        <div class="well metro-height">
                            <div class="tile btn btn-primary" data-role="tile"
                                ...
                                <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/餐饮管理员/管理员设置.htm');">
                                    <i class="fa fa-question fa-lg"></i>
                                </a>
                    ...
                    <div class="in" id="collapseLi6" aria-expanded="true">
                        <div class="well metro-height">
                            <div class="tile btn btn-primary" data-role="tile"
                                ...
                                <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/餐饮管理员/密码修改.htm');">
                                    <i class="fa fa-question fa-lg"></i>
                                </a>
                ...
                <div class="in" id="collapseLi1" aria-expanded="true">
                    <div class="well metro-height">
                        <div class="tile btn btn-primary" data-role="tile"
                            ...
                            <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/景区管理员/关注时回复.htm');">
                                <i class="fa fa-question fa-lg"></i>
                            </a>
                        ...
                        <div class="tile btn btn-primary" data-role="tile"
                            ...
                            <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/景区管理员/默认回复.htm');">
                                <i class="fa fa-question fa-lg"></i>
                            </a>
                        ...
                        <div class="tile btn btn-primary" data-role="tile"
                            ...
                            <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/景区管理员/文本回复.htm');">
                                <i class="fa fa-question fa-lg"></i>
                            </a>
                        ...
                        <div class="tile btn btn-primary" data-role="tile"
                            ...
                            <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/景区管理员/图文回复.htm');">
                                <i class="fa fa-question fa-lg"></i>
                            </a>
                        ...
                        <div class="tile btn btn-primary" data-role="tile"
                            ...
                            <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/景区管理员/语音回复.htm');">
                                <i class="fa fa-question fa-lg"></i>
                            </a>
                ...
                <div class="in" id="collapseLi2" aria-expanded="true">
                    <div class="well metro-height">
                        <div class="tile btn btn-primary" data-role="tile"
                            ...
                            <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/景区管理员/菜单设置.htm');">
                                <i class="fa fa-question fa-lg"></i>
                            </a>
                    ...
                    <div class="in" id="collapseLi3" aria-expanded="true">
                        <div class="well metro-height">
                            <div class="tile btn btn-primary" data-role="tile"
                                ...
                                <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/景区管理员/景区导览.htm');">
                                    <i class="fa fa-question fa-lg"></i>
                                </a>
                    ...
                    <div class="in" id="collapseLi4" aria-expanded="true">
                        <div class="well metro-height">
                            <div class="tile btn btn-primary" data-role="tile"
                                ...
                                <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/景区管理员/摇一摇.htm');">
                                    <i class="fa fa-question fa-lg"></i>
                                </a>
                    ...
                    <div class="in" id="collapseLi5" aria-expanded="true">
                        <div class="well metro-height">
                            <div class="tile btn btn-primary" data-role="tile"
                                ...
                                <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/景区管理员/门票订单统计.htm');">
                                    <i class="fa fa-question fa-lg"></i>
                                </a>
                    ...
                    <div class="in" id="collapseLi6" aria-expanded="true">
                        <div class="well metro-height">
                            <div class="tile btn btn-primary" data-role="tile"
                                ...
                                <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/景区管理员/酒店管理.htm');">
                                    <i class="fa fa-question fa-lg"></i>
                                </a>
                    ...
                    <div class="in" id="collapseLi7" aria-expanded="true">
                        <div class="well metro-height">
                            <div class="tile btn btn-primary" data-role="tile"
                                ...
                                <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/景区管理员/餐饮管理.htm');">
                                    <i class="fa fa-question fa-lg"></i>
                                </a>
                    ...
                    <div class="in" id="collapseLi8" aria-expanded="true">
                        <div class="well metro-height">
                            <div class="tile btn btn-primary" data-role="tile"
                                ...
                                <a href="#" class="tile-step-icon" onclick="javascript:jumpdirect('Functoin/StaticPage/Admin/usehelp/景区管理员/密码修改.htm');">
                                    <i class="fa fa-question fa-lg"></i>
                                </a>
