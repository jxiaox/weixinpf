...
namespace WeixinPF.Model.Article
{
    /// <summary>
    /// 内容类别
    /// </summary>
    ...
    public partial class ArticleCategoryInfo
    {
        ...
        private List<ArticleImagesSizeInfo> _imagesize_values;
        /// <summary>
        /// 图片尺寸
        /// </summary>
        public List<ArticleImagesSizeInfo> imagesize_values
        {
