<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hotel_dingdan_cz.aspx.cs" Inherits="WeixinPF.Hotel.Plugins.Functoin.BackPage.Hotel.hotel_dingdan_cz" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>退款操作日期：</dt>
                <dd><span><%=RefundOrder.refundTime.ToString("yyyy/MM/dd") %></span></dd>
            </dl>
            <dl>
                <dt>退款操作人员：</dt>
            ...
            <dl>
                <dt>退款金额：</dt>
                <dd><span><%=RefundOrder.refundAmount %>元</span></dd>
            </dl>
            <%}%>
        </div>
