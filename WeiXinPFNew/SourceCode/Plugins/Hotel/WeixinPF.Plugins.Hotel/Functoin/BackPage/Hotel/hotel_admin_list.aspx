<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hotel_admin_list.aspx.cs" Inherits="WeixinPF.Hotel.Plugins.Functoin.BackPage.Hotel.hotel_admin_list" %>
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li>
                            <a class="icon-btn add" href="hotel_admin_edit.aspx?action=<%=MXEnums.ActionEnum.Add %>&hotelid=<%=hotelid%>">
                                <i></i>
                                <span>新增管理员</span>
                            </a>
                        </li>
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center">
                        <a href="hotel_admin_edit.aspx?shopid=<%#hotelid %>&action=<%#MXEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
